...
class RiddlesForum extends StatefulWidget {
  const RiddlesForum({ Key? key,}) : super(key: key);

  @override
  State<RiddlesForum> createState() => _RiddlesForumState();
}

class _RiddlesForumState extends State<RiddlesForum> {
    ...
    return Consumer<RiddleViewModel>(
            builder: (context,fetch,child) {
              ...
              return Column(
                ...
                children: [
                  CustomText(text: "Riddles",size: 16.sp,color:const Color(0xff000000),weight: FontWeight.w700,),
                //   InkWell(
                // onTap: ()=> Navigator.pushNamed(context, Riddles.routeName),
              ...
              Container(
                  ...
                  width: MediaQuery.of(context).size.width,
                    child:fetch.riddleList.isEmpty ?
                         const Center(child: CustomText(text: "Opps sorry no riddles & quote added yet",),)
                         :   ListView.builder(      
                      scrollDirection: Axis.horizontal,
                      // scrollDirection: ScrollDirection.,
                      itemCount:fetch.riddleList.length > 8 ? 8 : fetch.riddleList.length,
                              ...
                              children: [
                                ClipRRect(
                                  ...
                                  Padding(
                                    ...
                                    child: CustomText(text: fetch.riddleList[index].question,size:11.sp,color:const Color(0xff657786),maxLines: 1,overflow:TextOverflow.ellipsis,),
                                  )             
                                  ],
                                 ),
                               ),
