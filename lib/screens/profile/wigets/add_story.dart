...
class _AddStoryState extends State<AddStory> with AutomaticKeepAliveClientMixin {
...
/// Get image from gallery
 Future getFromGallery(BuildContext context) async {
  ...
  FocusScope.of(context).unfocus();
    ...
    // );
    final ImageSelector imageGetter =  ImageSelector();
;
    String? imageUrl;
    if(imageGetter.imageFile != null){
     imageUrl = await UploadImage.uploadImage(image: imageGetter.imageFile);
    }
   imageGetter.imageFile = null;
  ...
  Widget build(BuildContext context) {
    ...
    // final provider = Provider.of<SharePostViewModel>(context);
    return Scaffold(
