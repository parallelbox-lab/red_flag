...
import 'package:red_flag/screens/admin/forum_admin/widgets/create_affirmations.dart';
...
class AffirmationAdmin extends StatefulWidget {
  const AffirmationAdmin({ Key? key }) : super(key: key);

  @override
  State<AffirmationAdmin> createState() => _AffirmationAdminState();
}

class _AffirmationAdminState extends State<AffirmationAdmin> {
  @override
  void initState() {
    super.initState();
      ...
      child: Padding(
        ...
        child: Column(children: [
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              CustomText(text: "Affirmation", size: 18.sp,weight: FontWeight.w700,),
               Padding(
                  ...
                  child: TextButton(
                      ...
                      onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (ctx)=>const CreateAffirmation())),
                      child: Row(mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                         const Icon(Icons.add, color:Colors.white),
                         const SizedBox(width:5),
                          Expanded(
                            child: Text("New Affirmations",
                                style: TextStyle(
                                    fontFamily: 'Core Pro',
                                    fontSize: 13.0.sp,
                   ...
                   return CustomScrollView(                             
                      ...
                      SliverList(
                        delegate: SliverChildBuilderDelegate(
                              (context, index) {
                              final data = vm.affirmationList[index];
                                return InkWell(
                                  onTap: () {
                                  ...
                                  // contentPadding:const EdgeInsets.all(7),
                                    ...
                                    title: Column(
                                      ...
                                      const SizedBox(height:10),
                                        ...
                                        Flexible(child: CustomText(text:data.postCreated,size:13.sp,color:kBlackColor,weight:FontWeight.w400,textAlign: TextAlign.center,maxLines: 2,overflow: TextOverflow.ellipsis,)),
                              ...
                              childCount:vm.affirmationList.length,
                        ),
                      ),
                    ],
                         );
