...
import 'package:red_flag/screens/admin/forum_admin/widgets/create_video.dart';
import 'package:red_flag/view_model/music_view_model.dart';
import 'package:red_flag/widgets/custom_text.dart';
import 'package:sizer/sizer.dart';

import '../../../../utils/constants.dart';
class MusicVideoAdmin extends StatefulWidget {
  const MusicVideoAdmin({ Key? key }) : super(key: key);

  @override
  State<MusicVideoAdmin> createState() => _MusicVideoAdminState();
}

class _MusicVideoAdminState extends State<MusicVideoAdmin> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          CustomText(text: "Music Video", size: 18.sp,weight: FontWeight.w700,),
           Padding(
              ...
              child: TextButton(
                  style: TextButton.styleFrom(
                    ...
                    backgroundColor:Colors.blue,
                      ...
                      onPressed: ()=> Navigator.push(context, MaterialPageRoute(builder: (ctx)=>const CreateVideo())),
                  child: Row(mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                     const Icon(Icons.add, color:Colors.white),
                     const SizedBox(width:5),
                      Expanded(
                        child: Text("New Music Video",
                            style: TextStyle(
                                fontFamily: 'Core Pro',
                                fontSize: 13.0.sp,
                  ...
                  SliverList(
                    delegate: SliverChildBuilderDelegate(
                      ...
                      final data = vm.musicList[index];
                          ...
                          childCount:vm.musicList.length,
                        ),
                      ),
                    ],
                         );
