...
class CreateRiddles extends StatefulWidget {
  const CreateRiddles({ Key? key }) : super(key: key);

  @override
  State<CreateRiddles> createState() => _CreateRiddlesState();
}

class _CreateRiddlesState extends State<CreateRiddles> {
  File? _imageFile;
    ...
    body: SingleChildScrollView(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
          CustomText(text: "New Riddles", size: 18.sp,weight: FontWeight.w700,),
          ...
          const CustomText(text: "Post Details"),
          const SizedBox(height:15),
           TextField(
        ...
        const SizedBox(height: 15,),
        ButtonWidget(text: "Create Story",press:()=> provider.createPost(context))
        ],),
      ),
    ),
    );
